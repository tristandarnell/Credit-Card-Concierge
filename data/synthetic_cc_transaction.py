...
real_merchants = {
    "Groceries": ["WALMART", "TARGET", "COSTCO", "WHOLE FOODS", "TRADER JOE'S", "KROGER", "SAFEWAY", "ALDI", "LIDL", "PUBLIX", "HEB", "MEIJER", "SPROUTS"],
    ...
    "Public Transport": ["UBER", "LYFT", "AMTRAK", "NYC MTA", "BART", "WMATA", "SEPTA", "CTA", "LA METRO"],
    ...
    "Other": ["AMAZON MARKETPLACE", "ETSY", "EBAY", "PAYPAL", "SQUARE", "STRIPE", "FACEBOOK ADS", "GOOGLE SERVICES"]
}
